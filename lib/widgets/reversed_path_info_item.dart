...
class ReversedPathInfoItem extends StatelessWidget {
  const ReversedPathInfoItem(
      {super.key, required this.path, required this.isDisabled});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      color: isDisabled ? Color.fromARGB(255, 216, 216, 216) : null,
      foregroundDecoration: BoxDecoration(
          color: isDisabled ? Colors.grey : null,
          backgroundBlendMode: isDisabled ? BlendMode.saturation : null),
      child: Padding(
